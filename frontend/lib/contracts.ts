...
export const JOB_ESCROW_ABI = [
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'string', name: 'hspPaymentRef', type: 'string' },
        ],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'jobId', type: 'uint256' },
      { internalType: 'uint256', name: 'employerRefund', type: 'uint256' },
      { internalType: 'uint256', name: 'agentPayout', type: 'uint256' },
      { internalType: 'uint256', name: 'reputationScore', type: 'uint256' },
